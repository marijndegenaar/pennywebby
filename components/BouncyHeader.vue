...
const menuItems = ref([
  { route: '/words', icon: '/_nuxt/assets/images/btn_words.svg', text: 'Embodied Writing', x: 0, y: 0, dx: 0, dy: 0, size: 180 },
  { route: '/wandering', icon: '/_nuxt/assets/images/btn_wandering.svg', text: 'About me', x: 0, y: 0, dx: 0, dy: 0, size: 180 },
  { route: '/sound', icon: '/_nuxt/assets/images/btn_sounds.svg', text: 'Sounds', x: 0, y: 0, dx: 0, dy: 0, size: 180 },
  { route: '/senses', icon: '/_nuxt/assets/images/btn_senses.svg', text: 'Artistic Practice', x: 0, y: 0, dx: 0, dy: 0, size: 180 },
  { route: '/dreams', icon: '/_nuxt/assets/images/btn_dreams.svg', text: 'Poetry & Stories', x: 0, y: 0, dx: 0, dy: 0, size: 180 },
]);
