...
const menuItems = ref([
  ...
  { route: '/purplegreen', icon: '/images/btn_purplegreen.svg', text: 'Purple Green', x: 0, y: 0, dx: 0, dy: 0, size: 220 },
  { route: '/teaching', icon: '/images/btn_teaching.svg', text: 'Teaching', x: 0, y: 0, dx: 0, dy: 0, size: 180 },
